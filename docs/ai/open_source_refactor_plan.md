...
[`deprecated_paths.md`](deprecated_paths.md)、
[`../developer/safety.md`](../developer/safety.md) 和实际代码为准。
...
- [x] 建立上述分层文件；
- [x] 根目录旧 requirements 在迁移期只作为清晰的兼容聚合入口，不能复制两套版本约束；
...
- [x] 更新 `deprecated_paths.md`，区分“已删除”与“永久禁止恢复”。
...
[`p3_release_audit.md`](p3_release_audit.md)，但权利、私密报告渠道和历史对象处置尚未获得
维护者可核验证据；禁止公开发布。
...
| 阶段 | 状态 | 完成证据 |
| --- | --- | --- |
| P0-0 基线固化 | 已完成 | [`p0_0_baseline.md`](p0_0_baseline.md) |
| P0-1 Web 控制边界 | 已完成 | [`p0_security_decisions.md`](p0_security_decisions.md)、[`p0_acceptance.md`](p0_acceptance.md) |
| P0-2 Safety Pipeline | 已完成 | [`p0_security_decisions.md`](p0_security_decisions.md)、[`p0_acceptance.md`](p0_acceptance.md) |
| P0-3 删除 Action Dry Run | 已完成 | [`p0_acceptance.md`](p0_acceptance.md) |
| P0-4 P0 SITL 验收 | 已完成 | [`p0_acceptance.md`](p0_acceptance.md)、`scripts/validate_p0_sitl.py` |
...
| P3-1 法律/社区文件 | 阻塞 | D-09～D-11 未决；[`p3_release_decisions.md`](p3_release_decisions.md) |
| P3-2 仓库和历史审计 | 阻塞 | 模型/地形/截图及历史产物待处置；[`p3_release_audit.md`](p3_release_audit.md) |
