...
与 `AGENTS.md`、`current_architecture.md` 或安全文档冲突，以更严格的安全限制为准。
...
2. 阅读 `docs/ai/README.md`、`current_architecture.md`、`action_contracts.md`、
   `deprecated_paths.md`、`task_checklist.md`；
3. 阅读 `docs/developer/coordinate_frames.md`、`field_origin_heading.md`、`safety.md`；
4. 阅读本文完整内容，并确认用户指定的任务编号；
5. 运行 `git status --short` 和 `git diff --stat`；
