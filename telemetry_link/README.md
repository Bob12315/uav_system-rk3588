...
完整接口契约见 [../docs/ai/architecture/interfaces.md](../docs/ai/architecture/interfaces.md)。
...
状态字段单位和语义以 [../docs/ai/architecture/interfaces.md](../docs/ai/architecture/interfaces.md) 为准。
