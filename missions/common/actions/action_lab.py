...
_DEFINITIONS = (
    ...
    _definition("goto_waypoint", GotoWaypointAction, "Convert a FIELD target to GPS while holding yaw unless field-heading yaw is requested.",
                {"tolerance_xy_m": 0.3, "tolerance_z_m": 0.3, "min_hold_updates": 1, "require_velocity_valid": False, "max_horizontal_speed_mps": 0.15, "max_vertical_speed_mps": 0.10, "priority": 4},
