...
_DEFINITIONS = (
    ...
    _definition(
        ...
        {"target_altitude_m": 1.2, "descend_speed_mps": 0.2, "release_deadband_ex": 0.1, "release_deadband_ey": 0.1, "priority": 5, "max_vx_mps": 0.25, "max_vy_mps": 0.25, "kp_forward": 0.3, "kp_right": 0.3, "vx_sign": -1.0, "vy_sign": 1.0, "field_yaw_deg": 0.0},
        properties={"target_altitude_m": {"type": "number", "exclusiveMinimum": 0}, "descend_speed_mps": {"type": "number", "minimum": 0}, "release_deadband_ex": {"type": "number", "exclusiveMinimum": 0}, "release_deadband_ey": {"type": "number", "exclusiveMinimum": 0}, "priority": _INTEGER, "key": _STRING, "max_vx_mps": {"type": "number", "exclusiveMinimum": 0}, "max_vy_mps": {"type": "number", "exclusiveMinimum": 0}, "kp_forward": {"type": "number", "minimum": 0}, "kp_right": {"type": "number", "minimum": 0}, "vx_sign": {"type": "number", "enum": [-1, 1]}, "vy_sign": {"type": "number", "enum": [-1, 1]}, "field_yaw_deg": _NUMBER, "desired_yaw_deg": {"type": ["number", "null"]}},
        required_inputs=("scene", "drone.relative_altitude", "field_heading_yaw_rad"), effects=("flight_command",), exit_barrier=ExitBarrier.MOTION_STOPPED),
