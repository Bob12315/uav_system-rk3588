...
_ALIGN_LEGACY_CONFIG = {"type": "object", "properties": {
    ...
    "fov_x_deg": _NUMBER, "fov_y_deg": _NUMBER, "height_gain_enabled": _BOOLEAN, "height_gain_mode": _STRING,
    ...
    "image_x_sign": _NUMBER, "image_y_sign": _NUMBER, "integral_active_below_altitude_m": _NUMBER,
    "integral_enabled": _BOOLEAN, "integral_vx_limit_mps": _NUMBER, "integral_vy_limit_mps": _NUMBER,
    "ki_vx": _NUMBER, "ki_vy": _NUMBER, "max_payload_offset_ex_cam": _NUMBER, "max_payload_offset_ey_cam": _NUMBER,
    ...
    "payload_forward_m": _NUMBER, "payload_offset_enabled": _BOOLEAN, "payload_right_m": _NUMBER,
...
_DEFINITIONS = (
    ...
    _definition("goto_waypoint", GotoWaypointAction, "Convert a FIELD target to GPS and fly with fixed FIELD-relative yaw.",
                {"field_yaw_deg": 0.0, "tolerance_xy_m": 0.3, "tolerance_z_m": 0.3, "min_hold_updates": 1, "require_velocity_valid": False, "max_horizontal_speed_mps": 0.15, "max_vertical_speed_mps": 0.10, "priority": 4},
    ...
    _definition(
        ...
        properties={"track_id": {"type": ["integer", "null"]}, "target_altitude_m": {"type": "number", "exclusiveMinimum": 0}, "finish_altitude_m": {"type": "number", "exclusiveMinimum": 0}, "max_duration_s": {"type": "number", "exclusiveMinimum": 0}, "descend_speed_mps": {"type": "number", "minimum": 0}, "descent_deadband_ex": {"type": "number", "exclusiveMinimum": 0}, "descent_deadband_ey": {"type": "number", "exclusiveMinimum": 0}, "release_deadband_ex": {"type": "number", "exclusiveMinimum": 0}, "release_deadband_ey": {"type": "number", "exclusiveMinimum": 0}, "finish_alignment_max_ex_cam": {"type": "number", "exclusiveMinimum": 0}, "finish_alignment_max_ey_cam": {"type": "number", "exclusiveMinimum": 0}, "alignment_hold_s": {"type": "number", "minimum": 0}, "max_target_age_s": {"type": "number", "exclusiveMinimum": 0}, "priority": _INTEGER, "key": _STRING, "max_vx_mps": {"type": "number", "exclusiveMinimum": 0}, "max_vy_mps": {"type": "number", "exclusiveMinimum": 0}, "kp_forward": {"type": "number", "minimum": 0}, "ki_forward": {"type": "number", "minimum": 0}, "kd_forward": {"type": "number", "minimum": 0}, "kp_right": {"type": "number", "minimum": 0}, "ki_right": {"type": "number", "minimum": 0}, "kd_right": {"type": "number", "minimum": 0}, "vx_sign": {"type": "number", "enum": [-1, 1]}, "vy_sign": {"type": "number", "enum": [-1, 1]}, "field_yaw_deg": _NUMBER, "desired_yaw_deg": {"type": ["number", "null"]}, "config": _ALIGN_LEGACY_CONFIG, "expected_dt_s": _NUMBER, "lost_timeout_updates": _INTEGER, "hold_updates_required": _INTEGER, "max_retries": _INTEGER, "max_updates": _INTEGER, "finish_policy": _STRING, "finish_alignment_hold_updates": _INTEGER, "finish_alignment_timeout_s": _NUMBER},
    ...
    _definition("gps_fuse_views", GpsFuseViewsAction, "Fuse Mission-captured GPS views.", {"views": [], "fusion": {}, "class_names": []}, properties={"views": {"type": "array", "items": {"type": "object", "properties": _GPS_CAPTURE_OUTPUT, "additionalProperties": False}}, "fusion": {"type": "object", "properties": {"cluster_radius_m": {"type": "number", "minimum": 0}, "outlier_radius_m": {"type": "number", "minimum": 0}, "min_cluster_size": {"type": "integer", "minimum": 1}, "center_weight_power": {"type": "number", "minimum": 0}, "min_confidence": {"type": "number", "minimum": 0}, "max_abs_ex": {"type": ["number", "null"]}, "max_abs_ey": {"type": ["number", "null"]}}, "additionalProperties": False}, "class_names": _STRING_ARRAY}, output_properties={"localized_objects": {"type": "array", "items": _LOCALIZED_OBJECT}, "objects": {"type": "array", "items": _LOCALIZED_OBJECT}, "raw_estimates_count": _INTEGER, "count": _INTEGER, "coordinate_frame": {"type": "string", "const": "GLOBAL"}}, required_inputs=("field_reference",)),
    _definition("gps_target_lock", GpsTargetLockAction, "Lock a target using captured GPS pose.", {"max_match_distance_m": 1.2, "max_updates": 40, "min_confidence": 0.35, "class_names": [], "camera": {"fov_x_deg": 51.3, "fov_y_deg": 39.6}, "detection_source": "scene", "require_track_id": True}, properties={"target": _TARGET, "max_match_distance_m": {"type": "number", "exclusiveMinimum": 0}, "max_updates": {"type": "integer", "minimum": 1}, "min_confidence": {"type": "number", "minimum": 0}, "class_names": _STRING_ARRAY, "camera": _CAMERA, "detection_source": {"type": "string", "enum": ["scene", "perception"]}, "require_track_id": _BOOLEAN, "direct_release_when_exhausted": _BOOLEAN, "try_next_target_on_failure": _BOOLEAN}, parameter_schema_extra={"required": ["target"]}, required_inputs=("scene", "drone"), effects=("yolo_lock_target",)),
)
