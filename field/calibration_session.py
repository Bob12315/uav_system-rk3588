...
class CalibrationSession:
    ...
    def _apply(
        ...
        *,
        ...
        try:
            builder_snapshot = self._builder.snapshot_calibration_metadata()
        except Exception as exc:
            return self._transaction_failure(
        ...
        try:
            builder_ok = self._builder.set_calibration_metadata(candidate)
        except Exception as exc:
            return self._transaction_failure(
        ...
        try:
            synced = _reference_matches_candidate(candidate, service_status, require_frozen=False)
        except Exception as exc:
            return self._transaction_failure(
        ...
        try:
            synced = _reference_matches_candidate(candidate, frozen_status, require_frozen=True)
        except Exception as exc:
            return self._transaction_failure(
    ...
    def _rollback(
        ...
        try:
            builder_ok = (
                self._builder.restore_calibration_metadata(builder_snapshot)
                is True
            )
        except Exception:
            builder_ok = False
