...
echo "  telemetry: real; verify config/telemetry.yaml against the flight controller Ethernet settings"
echo "  video:     USB camera stable by-id path in config/yolo.yaml"
