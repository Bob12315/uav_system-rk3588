...
from contracts.platform.field import GpsObservation  # noqa: E402
...
def main() -> None:
    ...
    if [path.name for path in profiles] != ["competition_runtime.json"]:
        raise SystemExit("only competition_runtime.json may be shipped")
    ...
    for index in range(48):
        ...
        controller.observe_runtime_profile_sampling(GpsObservation(
            observation_id=f"validator:{index}", observed_at_s=observed_at_s,
