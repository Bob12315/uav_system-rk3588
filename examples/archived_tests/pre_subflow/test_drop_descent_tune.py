...
def test_complete_v2_finish_window_and_deadline():
    data = json.loads(open("config/action_missions/rescue_2026_full_auto_v2.json").read())
...
def test_v1_unchanged():
    ...
    import os
    for path in ["examples/archived_missions/drop_two_targets_v1.json", "examples/archived_missions/rescue_2026_full_auto.json"]:
