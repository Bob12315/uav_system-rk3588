# Archived template contracts for the pre-subflow composite runtime.
...
from missions.engine import MissionActionStep, MissionBlackboard
...
TEMPLATE_PATHS = [
    Path("examples/archived_missions/drop_two_targets_v1.json"),
    Path("examples/archived_missions/recon_sequence_v1.json"),
    Path("examples/archived_missions/rescue_2026_full_auto.json"),
...
def test_sitl_profile_matches_base_full_template() -> None:
    sitl_path = Path("examples/archived_missions/sitl/rescue_2026_full_auto.json")
...
def test_recon_inspect_stepwise_v2_loads() -> None:
    ...
    path = Path("examples/archived_missions/recon_inspect_5_targets_stepwise_v2.json")
    data = _template(path)
...
def test_recon_inspect_stepwise_v2_sitl_matches_base() -> None:
    ...
    base = _template(Path("examples/archived_missions/recon_inspect_5_targets_stepwise_v2.json"))
    sitl = _template(Path("examples/archived_missions/sitl/recon_inspect_5_targets_stepwise_v2.json"))
    assert sitl == base
