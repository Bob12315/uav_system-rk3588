...
def test_field_survey_converts_to_global_target() -> None:
    action = SurveyAreaAction()
    action.start(_params(
    ...
    result = action.update({
        "drone": {"global_position_valid": False, "lat": 34.0, "lon": 108.0, "relative_altitude": 5.0},
    ...
    assert result.detail["global_target"]["lon"] > 108.0
