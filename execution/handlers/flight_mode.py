...
def dispatch_set_mode(
    ...
    *,
    ...
    receipt = sender(mode, priority=priority)
    return submission_outcome(receipt, {
...
def dispatch_arm(
    ...
    *,
    ...
    receipt = sender(priority=priority)
    return submission_outcome(receipt, {
...
def dispatch_takeoff(
    ...
    *,
    ...
    receipt = sender(altitude_m, priority=priority)
    return submission_outcome(receipt, {
...
def dispatch_condition_yaw(
    ...
    *,
    ...
    receipt = sender(yaw_deg, yaw_speed_deg_s, direction, relative, priority=priority)
    return submission_outcome(receipt, {
...
def dispatch_change_speed(
    ...
    *,
    ...
    receipt = sender(speed_mps, speed_type, priority=priority)
    return submission_outcome(receipt, {
