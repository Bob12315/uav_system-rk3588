...
from execution.normalizer import get_action_params, optional_float
...
def dispatch_global_goto(
    ...
    *,
    ...
    kwargs = {"lat": lat, "lon": lon, "alt": alt, "frame": frame,
              "priority": priority, "yaw_rad": yaw_rad}
    if params.get("field_reference_version") is not None:
        kwargs["field_reference_version"] = params["field_reference_version"]
    receipt = sender(**kwargs)
    ...
    return (submission_outcome(receipt, detail), log_msg)
