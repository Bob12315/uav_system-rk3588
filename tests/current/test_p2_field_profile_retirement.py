...
from app.field_profile import FieldProfileValidationError, load_field_profile_json, parse_field_profile
...
def test_runtime_field_reference_truthfully_has_no_local_ned_transform() -> None:
    ...
    assert status["is_ready_for_field_to_local"] is False
