...
from app.safety_pipeline import ActionSafetyPipeline
...
def test_navigation_takeoff_and_payload_envelopes_fail_closed() -> None:
    ...
    assert servo.reason_code == "servo_output_not_allowed"


def test_field_target_requires_confirmed_synced_frozen_transform() -> None:
    pipeline = ActionSafetyPipeline()
    ...
    request["field_local_transform_ready"] = True
    ...
    assert decision.reason_code == "field_reference_not_synced"
