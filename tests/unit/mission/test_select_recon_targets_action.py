...
def test_zone_center_mode_field_with_complete_context():
    ...
    ctx = {"field_gps_transform_confirmed": True, "field_heading_yaw_rad": 0.0}
    near = {"id": "near", "class_name": "bucket", "east_m": 0.0, "north_m": 10.0,
            "lat": 34.0, "lon": 108.0, "seen_count": 1, "raw_count": 1, "weight": 1.0}
    far = {"id": "far", "class_name": "bucket", "east_m": 10.0, "north_m": 0.0,
           "lat": 34.0, "lon": 108.001, "seen_count": 1, "raw_count": 1, "weight": 1.0}
    action = SelectReconTargetsAction()
...
def test_zone_center_mode_field_heading_pi_over_2():
    ...
    import math
    ctx = {"field_gps_transform_confirmed": True, "field_heading_yaw_rad": math.pi / 2}
    near = {"id": "near", "class_name": "bucket", "east_m": 10.0, "north_m": 0.0,
            "lat": 34.0, "lon": 108.0, "seen_count": 1, "raw_count": 1, "weight": 1.0}
    far = {"id": "far", "class_name": "bucket", "east_m": 0.0, "north_m": 10.0,
           "lat": 34.001, "lon": 108.0, "seen_count": 1, "raw_count": 1, "weight": 1.0}
    action = SelectReconTargetsAction()
    action.start({"objects": [far, near], "target_count": 1, "allow_fewer": True,
                  "deduplicate_radius_m": 0.45, "zone_center": {"x": 0.0, "y": 10.0},
                  "zone_center_mode": "field", "coordinate_mode": "gps_enu"})
