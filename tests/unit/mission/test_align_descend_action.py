...
from missions.common.lifecycle import align_descend as _ad
...
def test_low_altitude_integral_uses_monotonic_time_and_resets_on_deadband(monkeypatch) -> None:
    ...
    monkeypatch.setattr("missions.common.lifecycle.align_descend.time.monotonic", lambda: next(clock))
    action = AlignDescendAction()
